...
<div class="co-daftarguru">
    <form name="form" action="simpan_guru.php" method="POST">
        ...
        <div class="box-content">
            <div class="col-25">
                <label class="required">Pelajaran</label>
            </div>
            <div class="col-75">
                <input type="text" name="pelajaran" placeholder="Masukkan Pelajaran yang ingin diajar" maxlength="30">
            </div>
        </div>
