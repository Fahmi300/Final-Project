            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                <ul class="navbar-nav flex-row justify-content-between">
                    <li class="nav-item navigasi-link navigasi-jarak">
                        <a class="nav-link navigasi-link" aria-current="page" href="kelas.php" style="font-family: 'Inter', sans-serif; margin: 0px;">Kelas</a>
                    </li>
                    <li class="nav-item navigasi-link navigasi-jarak">
                    ...
                    <?php endif; ?>
                    <li class="nav-item navigasi-link navigasi-jarak">
                        <a class="nav-link navigasi-link" href="logout.php" style="font-family: 'Inter', sans-serif; margin: 0px;">Keluar</a>
                    </li>
                </ul>
                <div class="row md-0 justify-content-between">
                    <div class="col-lg-6 order-lg-2 md-2">
                        <a href="login.html">
                            <img src="img/icon/default-profile.jpg" width="65px" height="65px" style="border: white; border-radius: 50%;">
                        </a>
                    </div>
